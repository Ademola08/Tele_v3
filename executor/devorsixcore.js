...
┃◍ Bugname: ${global.namabot}
┃◍ Prefix:  ${prefix} 
┃◍ version: Last Version
┃◍ Status: ${tdx.public ? 'Public' : 'Self'}
...
┏┉┉┉▢ Bug
┋.command 5
┋.atme_devorsixc < no amount >
┋.allv <no amount>
┋.crashome <no amount>
┋.crashpix <no amount>
┋.crashsql <no amount>
┋.crashimmune <no amount>
┋.iosb <ios>
┋.paymsg <ios>
┋.crashspace
┋.extend_text
...
footer: {
text: "𝑮𝒉𝒂𝒔𝒕 𝑪𝒍𝒂𝒏 𝑮𝒓𝒆𝒚 ❂"
},
nativeFlowMessage: {
buttons: [{
name: "cta_url",
buttonParamsJson: `{
display_text: 'Naruto V3.5 東',
url: "${global.url2}",
...
break
                 case 'runtime': case 'ednut': case 'naruto':
                let pinga = ` ⊡ 𝒏𝒂𝒓𝒖𝒕𝒐 𝒗3.5 𝒂𝒄𝒕𝒊𝒗𝒆 𝒇𝒐𝒓 ⊡ ${runtime(process.uptime())}
𝒗𝒆𝒓𝒔𝒊𝒐𝒏❚:- 3.5
𝒔𝒕𝒂𝒕𝒖𝒔❚:- Active 
𝒑𝒍𝒂𝒕𝒇𝒐𝒓𝒎❚:- Linux
𝒑𝒓𝒆𝒇𝒊𝒙❚:- multiple 
𝒄𝒓𝒆𝒂𝒕𝒐𝒓❚:-  ${global.NamaOwner}`
                tdx.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: `Naruto v3.5 東`,
                            body: `n⃠αrutσ`,
                            thumbnailUrl: 'https://tmpfiles.org/dl/12495366/tmp.jpg',
